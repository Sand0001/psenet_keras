...
def evaluate_method(gtFilePath, submFilePath, evaluationParams):
    ...
    def polygon_from_points(points):
        ...
        # pointMat = np.empty([2,4],dtype='int32')
    ...
    # gt = rrc_evaluation_funcs.load_folder_file(gtFilePath, evaluationParams['GT_SAMPLE_NAME_2_ID'],True)
    gt = rrc_evaluation_funcs.load_folder_file(gtFilePath, allEntries=True)
    subm = rrc_evaluation_funcs.load_folder_file(submFilePath,allEntries= True)
